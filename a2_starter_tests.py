...
from word_ladder_puzzle import WordLadderPuzzle, EASY, MEDIUM, TRIVIAL, \
    IMPOSSIBLE
...
def test_has_unique_solution_doctest2() -> None:
    s = SudokuPuzzle(4, [["A", "B", "C", "D"],
                         ["C", "D", " ", " "],
                         [" ", " ", " ", " "],
                         [" ", " ", " ", " "]],
...
def test_has_unique_solution_doctest3() -> None:
    s = SudokuPuzzle(4, [["B", "D", "A", "C"],
                         ["C", "A", "B", "D"],
                         ["A", "B", " ", " "],
                         [" ", " ", " ", " "]],
...
def test_has_unique_solution_doctest4() -> None:
...
def test_has_unique_solution_doctest5() -> None:
    s = SudokuPuzzle(4, [["C", "D", "B", "A"],
                         ["B", "A", "D", "C"],
                         ["D", "C", "A", "B"],
                         ["A", "B", "C", "D"]],
...
def test_has_unique_solution_doctest6() -> None:
    s = SudokuPuzzle(9, [['1', ' ', '4', ' ', ' ', '2', ' ', '5', ' '],
                         [' ', '2', ' ', ' ', ' ', ' ', ' ', ' ', ' '],
                         ['5', '7', ' ', ' ', ' ', ' ', ' ', ' ', ' '],
                         ['6', ' ', ' ', '5', '9', ' ', '1', ' ', ' '],
                         [' ', '4', ' ', ' ', ' ', ' ', ' ', '9', ' '],
...
def test_has_unique_solution_doctest7() -> None:
    s = SudokuPuzzle(9, [[' ', '8', ' ', ' ', ' ', '9', '7', '4', '3'],
                         [' ', '5', ' ', ' ', ' ', '8', ' ', '1', ' '],
                         [' ', '1', ' ', ' ', ' ', ' ', ' ', ' ', ' '],
                         ['8', ' ', ' ', ' ', ' ', '5', ' ', ' ', ' '],
                         [' ', ' ', ' ', '8', ' ', '4', ' ', ' ', ' '],
...
def test_dfs_solver_example2() -> None:
    ...
    expected = SudokuPuzzle(9, [['1', '9', '4', '7', '3', '2', '6', '5', '8'],
                                ['8', '2', '6', '9', '4', '5', '7', '3', '1'],
                                ['5', '7', '3', '1', '8', '6', '9', '2', '4'],
                                ['6', '8', '2', '5', '9', '3', '1', '4', '7'],
                                ['3', '4', '1', '8', '2', '7', '5', '9', '6'],
    ...
    assert y[0] == s and y[-1] == expected and len(y) == 55


def test_dfs_solver_example3() -> None:
    ...
    assert len(y) == 1 and y[0] == s


def test_dfs_solver_example4() -> None:
    s = SudokuPuzzle(9, [['1', '9', '4', '7', '3', '2', '6', '5', '8'],
                     ['8', '2', '6', '9', '4', '5', '7', '3', '1'],
                     ['5', '7', '3', '1', '8', '6', '9', '2', '4'],
                     ['6', '8', '2', '5', '9', '3', '1', '4', '7'],
                     ['3', '4', '1', '8', '2', '7', '5', '9', '6'],
...
def test_dfs_solver_example5() -> None:
...
def test_dfs_solver_example6() -> None:

    s = SudokuPuzzle(9, [['1', '3', '4', '7', ' ', '2', ' ', '5', ' '],
                         [' ', '2', ' ', ' ', ' ', ' ', ' ', ' ', ' '],
                         ['5', '7', ' ', ' ', ' ', ' ', ' ', ' ', ' '],
                         ['6', ' ', ' ', '5', '9', ' ', '1', ' ', ' '],
                         [' ', '4', ' ', ' ', ' ', ' ', ' ', '9', ' '],
...
def test_dfs_solver_example7() -> None:
    ...
    assert len(y) == 58 and y[0] == s and y[-1].is_solved()
...
def test_bfs_solver_example2() -> None:
...
def test_bfs_solver_example3() -> None:
...
def test_bfs_solver_example4() -> None:
    s = SudokuPuzzle(9, [['1', '9', '4', '7', '3', '2', '6', '5', '8'],
                         ['8', '2', '6', '9', '4', '5', '7', '3', '1'],
                         ['5', '7', '3', '1', '8', '6', '9', '2', '4'],
                         ['6', '8', '2', '5', '9', '3', '1', '4', '7'],
...
def test_bfs_solver_example5() -> None:
...
def test_bfs_solver_example6() -> None:
    s = SudokuPuzzle(9, [['1', '3', '4', '7', ' ', '2', ' ', '5', ' '],
                         [' ', '2', ' ', ' ', ' ', ' ', ' ', ' ', ' '],
                         ['5', '7', ' ', ' ', ' ', ' ', ' ', ' ', ' '],
                         ['6', ' ', ' ', '5', '9', ' ', '1', ' ', ' '],
...
def test_bfs_solver_example7() -> None:
...
def test_word_ladder_extensions_doctest2() -> None:
    wl1 = WordLadderPuzzle("meer", "myer", {"no", "meep", "beer", "myer", "hi",
                                            "yes", "moer", "loer", "meer"})
    y = wl1.extensions()
    a = ["meep", "beer", "myer", "moer"]
    assert len(y) == 4
    assert all([y[0].from_word in a,
                y[1].from_word in a,
                y[2].from_word in a,
                y[3].from_word in a])
...
def test_word_ladder_dfs() -> None:
    wl1 = WordLadderPuzzle("me", "my", {"me", "my", "ma"})

    d = DfsSolver().solve(wl1)
    x = []
    for i in range(1, len(d)):
        x.append(d[i] in d[i-1].extensions())

    assert d[0] == wl1
    assert all(x)
    assert d[-1].is_solved()


def test_word_ladder_dfs2() -> None:
    wl1 = WordLadderPuzzle("meer", "pyal", {"no", "meep", "beer", "peel",
                                            "myer", "yes", "moer", "pyar",
                                            "loer", "pyal", "meer", "peer",
                                            "pear"})
...
def test_word_ladder_bfs() -> None:
    wl1 = WordLadderPuzzle("me", "my", {"me", "my", "ma"})
    b = BfsSolver().solve(wl1)
    x = []
    for i in range(1, len(b)):
        x.append(b[i] in b[i-1].extensions())

    assert b[0] == wl1
    assert all(x)
    assert b[-1].is_solved()


def test_word_ladder_bfs2() -> None:
    wl1 = WordLadderPuzzle("meer", "pyal", {"no", "meep", "beer", "peel",
                                            "myer", "yes", "moer", "pyar",
                                            "loer", "pyal", "meer", "peer",
                                            "pear"})
...
def test_word_ladder_get_difficulty() -> None:
    ...
    wl3 = WordLadderPuzzle("me", "my", {"mee", "myr", "mae"})
    assert wl3.get_difficulty() == IMPOSSIBLE

    wl4 = WordLadderPuzzle("meer", "pyal", {"no", "meep", "beer", "peel",
                                            "myer", "yes", "moer", "pyar",
                                            "loer", "pyal", "meer", "peer",
                                            "pear"})
    assert wl4.get_difficulty() == MEDIUM
...
def test_expression_tree_construct_from_list_doctest2() -> None:
    a = construct_from_list([['+'],
                             [3, '*', 'a', '+'],
                             ['a', '+'], [5, 'c'], [2, 'd']])

    assert a.__str__() == '(3 + (a * (2 + d)) + a + (5 + c))'
...
def test_expression_tree_substitute_doctest2() -> None:
    dic = {'+': '*', '*': '+', 'a': 3, 'b': 'c', 'c': 9}
    exp_t2 = ExprTree('+',
                      [ExprTree('*',
                                [ExprTree('+',
    ...
    assert exp_t2.__str__() == '(((a + (2 + b)) * 5) + (2 + c))'
    exp_t2.substitute(dic)
    assert exp_t2.__str__() == '(((3 * (2 * c)) + 5) * (2 * 9))'


def test_expression_tree_substitute_doctest3() -> None:
    exp_t3 = ExprTree('*', [ExprTree('a', []),
                            ExprTree('*',
                                     [ExprTree('a', []), ExprTree(1, [])])])

    exp_t3.substitute({})
    assert exp_t3.__str__() == '(a * (a * 1))'


def test_expression_tree_substitute_doctest4() -> None:
    exp_t4 = ExprTree(None, [])
    dic = {'+': '*', '*': '+', 'a': 3, 'b': 'c', 'c': 9}
    exp_t4.substitute(dic)

    assert exp_t4.__str__() == '()'
